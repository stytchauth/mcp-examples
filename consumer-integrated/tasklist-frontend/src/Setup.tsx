...
export default function Setup({children}: { children: ReactNode }) {
    ...
    if (backendHealth?.status === 'error') {
        return (
            <>
                <h1>
                    Error: Backend Configuration Issues
                </h1>
                <p>
                    ...
                    <>
                        ...
                        <ul>
                            {backendHealth.errors.map((error, index) => (
                                <li key={index}>
                                    <strong><code>{error.variable}</code></strong>: {error.description}
                                </li>
                            ))}
                        </ul>
                    </>
                ...
                <p>
                    ...
                    <a href="https://stytch.com/dashboard/project-settings?env=test" target="_blank"
