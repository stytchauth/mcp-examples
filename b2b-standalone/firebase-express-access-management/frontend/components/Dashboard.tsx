    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Welcome back! Here's what's happening with your organizations and
          requests.
        </p>
      </div>
          ...
          {!organization ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">
                Your organization will be created automatically based on your
                email domain.
              </p>
            </div>
          ) : (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <div className="text-sm text-gray-500">
              Track all your access requests
            </div>
          </button>
