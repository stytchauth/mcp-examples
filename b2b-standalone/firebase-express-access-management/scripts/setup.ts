...
async function main() {
  ...
  console.log(
    `We'll walk you through the steps to set up a Firebase project, a Stytch project, and a Vercel project.`,
  );
  console.log(
    `You'll need to have a Firebase account, a Stytch account, and a Vercel account to complete the setup.`,
  );
  console.log(
