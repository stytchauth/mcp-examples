...
import {AuthenticationContext, Todo} from "../types.d";
...
export class TodoMCP extends McpAgent<Env, unknown, AuthenticationContext> {
    ...
    public get todoService() {
        return todoService((this as any).env, (this as any).props.claims.sub)
    }

    public formatResponse = (description: string, newState: Todo[]): {
